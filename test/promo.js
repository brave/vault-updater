...
tap.test('platform identifiers', (t) => {
  t.ok(common.platformIdentifiers.OSX, 'osx platform identifier')
  t.ok(common.platformIdentifiers.WINDOWS_64, 'win64 platform identifier')
  t.ok(common.platformIdentifiers.WINDOWS_32, 'winia32 platform identifier')
  t.ok(common.platformIdentifiers.ANDROID, 'android platform identifier')
  t.ok(common.platformIdentifiers.IOS, 'ios platform identifier')
  t.end()
})
